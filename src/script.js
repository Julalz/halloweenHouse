...
for (let i = 0; i < 50; i++) {
  const angle = Math.random() * Math.PI * 2; //creamos un angulo para no tocar la casa
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight("white", 1, 3);
scene.add(ghost1);

const ghost2 = new THREE.PointLight("white", 1, 3);
scene.add(ghost2);

const ghost3 = new THREE.PointLight("white", 1, 3);
scene.add(ghost3);
